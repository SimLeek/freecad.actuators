        ...
        if self.bbox_radio.isChecked():
            ...
            if len(line1_inters)==2 and len(line2_inters)==2:
                ...
                if h[1]>line1_inters[1][1]:
                    t1_split = [line1_inters[1], h, g, line1_inters[0]]
                elif i[0]<line1_inters[0][0]:
                    t1_split = [line1_inters[1], g, i, line1_inters[0]]
                else:
                    t1_split = [line1_inters[1], g, line1_inters[0]]

                if line2_inters[1][0]<h[0]:
                    br_split = [line2_inters[0], j, h, line2_inters[1]]
                elif i[1]<line2_inters[0][1]:

                    br_split = [line2_inters[0], i, j, line2_inters[1]]
                else:
                    br_split = [line2_inters[0], j, line2_inters[1]]
            ...
            if (None not in line1_inters) and (None not in line2_inters):
                ...
                top_split = [b, a, line1_inters[0], line1_inters[1]]
                bottom_split = [c, d, line2_inters[1], line2_inters[0]]
